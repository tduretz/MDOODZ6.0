...
for ils=1:nsteps;
    ...
    [ etac, Txxc, Tyyc, Txyc, Exxc_el, Eyyc_el, Exyc_el ] = M2Di2_LocalIteration_VEP_TM_2( litmax, littol, noisy, Exxc, Eyyc, Exyc, Txxco, Tyyco, Txyco, Tc, T0, mc, etaec, Ptc, phic, Cc );
    [ etav, Txxv, Tyyv, Txyv, Exxv_el, Eyyv_el, Exyv_el ] = M2Di2_LocalIteration_VEP_TM_2( litmax, littol, noisy, Exxv, Eyyv, Exyv, Txxvo, Tyyvo, Txyvo, Tv, T0, mv, etaev, Ptv, phiv, Cv );
    % Momentum residual
    ...
    % Thermal residual
    Hs        = Txxc.*(Exxc-Exxc_el) + Tyyc.*(Eyyc-Eyyc_el) + 2*Txyc.*(Exyc-Exyc_el);
