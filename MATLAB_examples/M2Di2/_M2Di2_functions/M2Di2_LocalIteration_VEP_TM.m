function [ eta_0, Txx, Tyy, Txy, detadExx, detadEyy, detadExy ] = M2Di2_LocalIteration_VEP_TM( litmax, tol, noisy, Exx, Eyy, Exy, Txxo, Tyyo, Txyo, T, T0, m_pwl, eta_el, P, phi, C )
