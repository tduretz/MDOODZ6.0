function [ eta_0, Txx, Tyy, Txy, detadExx, detadEyy, detadExy ] = M2Di2_LocalIteration_VE( litmax, tol, noisy, Exx, Eyy, Exy, Txxo, Tyyo, Txyo, B_pwl, m_pwl, eta_el )
...
% detadExx =   (m_pwl.*(exx_pwl1)) .* eta_0.^2 ./ ( eta_pwl.*Eii_pwl2);
